/*! jqDim v3.7.1 | Copyright (c) 2021 cyfung1031 | https://raw.githubusercontent.com/cyfung1031/jqDim/main/LICENSE */
/*! jQuery v3.7.1 -ajax,-ajax/jsonp,-ajax/load,-ajax/script,-ajax/var/location,-ajax/var/nonce,-ajax/var/rquery,-ajax/xhr,-manipulation/_evalUrl,-deprecated/ajax-event-alias,-effects,-effects/Tween,-effects/animatedSelector | (c) OpenJS Foundation and other contributors | jquery.org/license */
( function( global ) {
    "use strict";
    ...
    const jLoop = ( arr, callback ) => {
        for ( const val of arr ) callback( val );
    }
    ...
    function boxModelAdjustment( elem, dimension, box, isBorderBox, styles, computedVal ) {
        ...
        for ( ; i < 4; i += 2 ) {
            const ce = cssExpand[ i ];

            // Both box models exclude margin
            // Count margin delta separately to only add it after scroll gutter adjustment.
            // This is needed to make negative margins work with `outerHeight( true )` (gh-3982).
            if ( box === "margin" ) {
                marginDelta += _css( elem, box + ce, true, styles );
            }

            // If we get here with a content-box, we're seeking "padding" or "border" or "margin"
            const borderDelta = _css( elem, "border" + ce + "Width", true, styles );
            if ( !isBorderBox ) {
    ...
    jEach( { Height: "height", Width: "width" }, ( name, type ) => {
        jEach( {
            ...
            jElement.prototype[ methodName ] = function( margin ) {
                ...
                if ( isWindow( elem ) ) {
                    ...
                    return !defaultExtra.length ? // methodName.indexOf( "outer" ) === 0
                        elem[ "inner" + name ] :
                ...
                if ( elem.nodeType === 9 ) {
                    const doc = elem.documentElement, body = elem.body;
